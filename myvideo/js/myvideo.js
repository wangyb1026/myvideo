// 基于jQuery构建, 兼容Chrome/Firefox/Edge Chromium;
	/*
	* 配置说明：
	* 实例化： new MyVideo();
	* 参数：
...
;(function(){
	...
	MyVideo.prototype.init = function(){
		...
		$('#videoWrapper').append(`<div class="loading"><img
			...
			</div><video src="" id="myvideo" class="myvideo" poster="">您的浏览器不支持播放HTML5视频</video>
			<div class="title"></div>
			<div class="bottom">
				<div class="processbar">
					<div class="bar"><span class="barlength" id="barlength"></span></div>
					<div class="time"><span id="curtime">--:--</span>/<span id="fulltime">--:--</span></div>
				</div>
				<div class="control">
					<div class="control-play"><i class="iconfont" id="play" title="播放">&#xe65c;</i><i class="iconfont" id="stop"
							title="停止">&#xe602;</i></div>
					<div class="control-volume"><i class="iconfont fullscreen" id="fullscreen" title="全屏">&#xe656;</i><i
							class="iconfont" id="volume" title="静音">&#xe6b1;</i>
						<div class="soundbar"><span class="soundbarlength"></span></div>
					</div>
				</div>
			</div>
